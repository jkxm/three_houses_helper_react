...
var allabilities = {
    ...
    'Battalion Wrath': ['If foe initiates combat while unit\xe2\x80\x99s battalion endurance is ≤ 1/3, grants Crit +50.',    'Raise Authority skill level to C for Hubert, Bernadetta, Caspar, Petra, Dimitri, Dedue, Hilda, Raphael, Seteth, Alois or Gibert. Raise to A for Annette or Claude.'],
    ...
    'Desperation': ['If unit initiates combat with HP ≤ 50%, unit\xe2\x80\x99s follow-up attack (if possible) occurs before foe\xe2\x80\x99s counterattack.',    'Class mastered: Cavalier'],
    ...
    'Hunter\xe2\x80\x99s Boon': ['Grants Crit +20 when foe\xe2\x80\x99s HP is ? 50%.',    'Personal: Petra'],
    ...
    'Lily\xe2\x80\x99s Poise': ['Adjacent allies take 3 less damage during combat.',    'Personal: Flayn'],
    ...
    'Miasma \xce\x94': ['Allows unit to cast Miasma \xce\x94. If Miasma \xce\x94 is already available, then unit can cast it twice as often.',    'Class: Dark Mage, Dark Bishop'],
    ...
    'Professor\xe2\x80\x99s Guidance': ['Multiplies this unit\xe2\x80\x99s and adjacent allies\xe2\x80\x99 experience earned by 1.2.',    'Personal: Protagonist'],
    'Professor\xe2\x80\x99s Guidance+': ['Unit deals 2 extra damage during combat. Multiplies this unit\xe2\x80\x99s and adjacent allies\xe2\x80\x99 experience earned by 1.2.',    'Personal: Protagonist (halfway through Chapter 10\xe2\x80\x99s story mission)'],
    'Quick Riposte': ['If foe initiates combat while unit\xe2\x80\x99s HP is \xe2\x89\xa5 50%, unit makes guaranteed follow-up attack.',    'Class mastered: War Master'],
    ...
    'Wrath': ['If foe initiates combat while unit\xe2\x80\x99s HP is ≤ 50%, grants Crit +50.',    'Class mastered: Warrior']
  };
