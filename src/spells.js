...
var spells = {
    ...
    'Dedue'      : [['Fire (D)', 'Bolganone (C)', 'Ragnarok (A)'                                       ],['Heal (D)', 'Nosferatu (D+)', 'Recover (C)'                             ]],
...
var abilities = {
    ...
    'Class mastered: Armored Knight'],
    'Armored Effect Null': ['Nullifies any extra effectiveness against armored units.',
    'Raise Heavy Armour skill level to S+'],
    'Authority Lv 1': ['Grants Mt +2 with gambits.',
    'Raise Authority skill level to E+'],
    'Authority Lv 2': ['Grants Mt +4 with gambits.',
    'Raise Authority skill level to D+'],
    'Authority Lv 3': ['Grants Mt +6 with gambits.',
    'Raise Authority skill level to C+'],
    'Authority Lv 4': ['Grants Mt +8 with gambits.',
    'Raise Authority skill level to B+'],
    'Authority Lv 5': ['Grants Mt +10 with gambits.',
    'Raise Authority skill level to A+'],
    'Avo +10': ['Increases Avo by 10.',
    'Class: Pegasus Knight, Falcon Knight, Wyvern Lord'],
    'Axe Avo +20': ['Grants Avo +20 when using an axe.', ''],
    'Axe Crit +10': ['Grants Crit +10 when using an axe.',
    'Raise Axe skill level to S, Class: Warrior'],
    'Axe Prowess Lv 1': ['Grants Hit +7, Avo +5, and Crit Avo +5 when using an axe.',
    'Raise Axe skill level to E+'],
    'Axe Prowess Lv 2': ['Grants Hit +10, Avo +6, and Crit Avo +6 when using an axe.',
    'Raise Axe skill level to D+'],
    'Axe Prowess Lv 3': ['Grants Hit +13, Avo +7, and Crit Avo +7 when using an axe.',
    'Raise Axe skill level to C+'],
    'Axe Prowess Lv 4': ['Grants Hit +16, Avo +8, and Crit Avo +8 when using an axe.',
    'Raise Axe skill level to B+'],
    'Axe Prowess Lv 5': ['Grants Hit +20, Avo +10, and Crit Avo +10 when using an axe.',
    'Raise Axe skill level to A+'],
    'Axebreaker': ['Grants Hit/Avo +20 when using a sword against axe users.',
    'Raise Sword skill level to B'],
    'Axebreaker+': ['Grants Hit/Avo +30 when using a sword against axe users.',
    ''],
    'Axefaire': ['Grants Atk +5 when using an axe.',
    'Raise Axe skill level to S+, Class: Armored Lord, Fortress Knight, Wyvern Rider, Warrior, Emperor, Wyvern Lord, Great Knight, War Master'],
    'Battalion Desperation': ['If unit initiates combat when battalion endurance is ≤ 1/3, unit\xe2\x80\x99s follow-up attack (if possible) occurs before foe\xe2\x80\x99s counterattack.',
    'Raise Authority skill level to C for Dorothea, Ferdinand, Ashe, Ingrid, Claude, Lysithea, Ignatz, Leonie, Hanneman, Cyril or Shamir. Raise to A for protagonist, Hubert or Seteth.'],
    'Battalion Renewal': ['Unit recovers up to 30% of max HP at the start of each turn while battalion endurance is ≤ 1/3.',
    'Raise Authority skill level to C for Linhardt, Mercedes, Annette, Marianne, Manuela or Flayn. Raise to A for Edelgard.'],
    'Battalion Vantage': ['When foe initiates combat, unit still attacks first if battalion endurance is ≤ 1/3.',
    'Raise Authority skill level to C for protagonist, Edelgard, Felix, Sylvain, Lorenz or Catherine. Raise to A for Dimitri or Ignatz.'],
    'Battalion Wrath': ['If foe initiates combat while unit\xe2\x80\x99s battalion endurance is ≤ 1/3, grants Crit +50.',
    'Raise Authority skill level to C for Hubert, Bernadetta, Caspar, Petra, Dimitri, Dedue, Hilda, Raphael, Seteth, Alois or Gibert. Raise to A for Annette or Claude.'],
    'Black Magic Avo +20': ['Grants Avo +20 when using black magic.',
    'Budding talent: Sylvain'],
    'Black Magic Crit +10': ['Grants Crit +10 when using black magic.',
    'Budding talent: Edelgard and Felix'],
    'Black Magic Range +1': ['Increases black magic range by 1.',
    'Raise Reason skill level to S (except for Edelgard, Hubert and Lysithea)'],
    ...
    'Class: Warlock, Gremory'],
    'Black Tomefaire': ['Grants Atk +5 when using black magic.',
    'Raise Reason skill level to S+ (except Edelgard, Hubert and Lysithea), Class: Warlock, Mortal Savant, Dark Knight'],
    ...
    'Raise Riding skill level to S+'],
    'Charm': ['Adjacent allies deal 3 extra damage during combat.',
    'Class: Lord, Armored Lord, High Lord, Wyvern Master, Emperor, Great Lord, Barbarossa'],
    ...
    'Raise Reason skill level to S for Edelgard, Hubert or Lysithea'],
    ...
    'Raise Reason skill level to S+ for Edelgard, Hubert or Lysithea, Class: Dark Knight'],
    'Darting Blow': ['If unit initiates combat, grants AS +6 during combat',
    'Class mastered: Pegasus Knight'],
    'Death Blow': ['If unit initiates combat, grants Str +6 during combat.',
    'Class mastered: Brigand'],
    ...
    'Class mastered: Falcon Knight'],
    'Defiant Crit': ['Grants Crit +50 when HP is ≤ 25%.',
    'Class mastered: Wyvern Lord'],
    'Defiant Def': ['Grants Def +8 when HP is ≤ 25%.',
    'Class mastered: Great Knight'],
    'Defiant Mag': ['Grants Mag +8 when HP is ≤ 25%.',
    'Class mastered: Gremory'],
    'Defiant Res': ['Grants Res +8 when HP is ≤ 25%.',
    'Class mastered: Holy Knight'],
    'Defiant Spd': ['Grants Spd +8 when HP is ≤ 25%.',
    'Class mastered: Bow Knight'],
    'Defiant Str': ['Grants Str +8 when HP is ≤ 25%.',
    'Class mastered: Hero'],
    'Desperation': ['If unit initiates combat with HP ≤ 50%, unit\xe2\x80\x99s follow-up attack (if possible) occurs before foe\xe2\x80\x99s counterattack.',
    'Class mastered: Cavalier'],
    ...
    'Raise Brawling skill level to S+, Class: Grappler, War Master'],
    'Flying Effect Null': ['Nullifies any extra effectiveness against fliers.',
    'Raise Flying skill level to S+'],
    ...
    'Hunter\xe2\x80\x99s Boon': ['Grants Crit +20 when foe\xe2\x80\x99s HP is ? 50%.',
    'Personal: Petra'],
    ...
    'Raise Lance skill level to S+, Class: High Lord, Paladin, Great Lord, Falcon Knight, Great Knight'],
    ...
    'Personal: Claude (from Part 2)'],
    'Lethality': ['Chance to instantly kill a foe when dealing damage. Trigger % = 0.25\xc3\x97Dex.',
    ...
    'Lily\xe2\x80\x99s Poise': ['Adjacent allies take 3 less damage during combat.',
    'Personal: Flayn'],
    ...
    'Personal: Lysithea'],
    'Miasma \xce\x94': ['Allows unit to cast Miasma \xce\x94. If Miasma \xce\x94 is already available, then unit can cast it twice as often.',
    'Class: Dark Mage, Dark Bishop'],
    'Miracle': ['Chance to survive lethal damage with 1 HP, if HP is > 1. Trigger % = Lck stat.',
    'Class mastered: Priest'],
    'Missing Number': ['Missing Number (icon is based on Wary Fighter)',
    'SpoOoOoky'],
    'Model Leader': ['Doubles experience earned for battalions.',
    'Raise Authority skill level to C+ for protagonist, Edelgard, Dimitri, Claude or Seteth'],
    ...
    'Raise Authority skill level to S+'],
    ...
    'Class mastered: Armored Lord, High Lord or Wyvern Master'],
    'Professor\xe2\x80\x99s Guidance': ['Multiplies this unit\xe2\x80\x99s and adjacent allies\xe2\x80\x99 experience earned by 1.2.',
    'Personal: Protagonist'],
    'Professor\xe2\x80\x99s Guidance+': ['Unit deals 2 extra damage during combat. Multiplies this unit\xe2\x80\x99s and adjacent allies\xe2\x80\x99 experience earned by 1.2.',
    'Personal: Protagonist (halfway through Chapter 10\xe2\x80\x99s story mission)'],
    'Quick Riposte': ['If foe initiates combat while unit\xe2\x80\x99s HP is \xe2\x89\xa5 50%, unit makes guaranteed follow-up attack.',
    'Class mastered: War Master'],
    'Rally Charm': ['Use Rally to grant Cha +8 to an ally.',
    'Raise Authority skill level for Edelgard (S), Dorothea (D), Dimitri (S), Claude (S) or Manuela (D)'],
    'Rally Defense': ['Use Rally to grant Def +4 to an ally.',
    'Raise Authority skill level to D for Seteth or Gilbert'],
    'Rally Dexterity': ['Use Rally to grant Dex +8 to an ally.',
    'Raise Authority skill level for Ferdinand (D) or Ignatz (C+)'],
    'Rally Luck': ['Use Rally to grant Lck +8 to an ally.',
    'Raise Authority skill level to D for Flayn'],
    'Rally Magic': ['Use Rally to grant Mag +4 to an ally.',
    'Raise Authority skill level to D for Hubert or Ingrid'],
    'Rally Movement': ['Use Rally to grant Mv +1 to an ally.',
    'Raise Authority skill level to S for protagonist or Annette'],
    'Rally Resistance': ['Use Rally to grant Res +4 to an ally.',
    'Raise Authority skill level for Hubert (C+), Annette (D) or Seteth (S)'],
    'Rally Speed': ['Use Rally to grant Spd +4 to an ally.',
    'Raise Authority skill level for Hubert (S), Annette (C+) or Ignatz (D)'],
    'Rally Strength': ['Use Rally to grant Str +4 to an ally.',
    'Raise Authority skill level for Raphael (C), Ignatz (S) or Alois (D)'],
    'Reason Lv 1': ['Grants Hit +7, Avo +5, and Crit Avo +5 when using black or dark magic.',
    'Raise Reason skill level to E+'],
    'Reason Lv 2': ['Grants Hit +10, Avo +6, and Crit Avo +6 when using black or dark magic.',
    'Raise Reason skill level to D+'],
    'Reason Lv 3': ['Grants Hit +13, Avo +7, and Crit Avo +7 when using black or dark magic.',
    'Raise Reason skill level to C+'],
    ...
    'Class: Thief, Class mastered: Thief'],
    ...
    'Class: Bishop, Gremory'],
    'White Tomefaire': ['Grants Atk +5 when using white magic.',
    'Raise Faith skill level to S+, Class: Holy Knight'],
    'Wrath': ['If foe initiates combat while unit\xe2\x80\x99s HP is ≤ 50%, grants Crit +50.',
    'Class mastered: Warrior']
  };

export {spells, combat_arts, universal_arts , abilities};
