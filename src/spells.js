...
var allabilities = {
    ...
    "Bow Crit +10"          : ["Grants Crit +10 when using a bow.", "Raise Bow skill level to S"],
    "Bow Prowess Lv 1"      : ["Grants Hit +6, Avo +6, and Crit Avo +5 when using a bow.","Raise Bow skill level to E+"],
    "Bow Prowess Lv 2"      : ["Grants Hit +8, Avo +8, and Crit Avo +6 when using a bow.","Raise Bow skill level to D+"],
    "Bow Prowess Lv 3"      : ["Grants Hit +10, Avo +10, and Crit Avo +7 when using a bow.","Raise Bow skill level to C+"],
    "Bow Prowess Lv 4"      : ["Grants Hit +12, Avo +12, and Crit Avo +8 when using a bow.","Raise Bow skill level to B+"],
    "Bow Prowess Lv 5"      : ["Grants Hit +15, Avo +15, and Crit Avo +10 when using a bow.","Raise Bow skill level to A+"],
    "Bowbreaker"            : ["Grants Hit/Avo +20 when using magic against bow users.", "Raise Reason skill level to B"],
    "Bowfaire"              : ["Grants Atk +5 when using a bow.", "Raise Bow skill level to S+, Class: Wyvern Master, Sniper, Barbarossa, Bow Knight"],
